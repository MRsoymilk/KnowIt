...
FormProperty::FormProperty(QWidget *parent)
    : QWidget(parent)
    , ui(new Ui::FormProperty)
{
    ui->setupUi(this);
    init();
...
void FormProperty::resizeEvent(QResizeEvent *event)
{
...
void FormProperty::setOriginate(const QJsonObject &data)
{
...
void FormProperty::on_btnDelete_clicked()
{
    emit selectedDataDelete();
}
